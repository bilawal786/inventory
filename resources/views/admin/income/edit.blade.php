        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form action="{{route('income.update',['id' => $incomeedit->id])}}" method="get" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="summernote"> {{$incomeedit->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
