                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input id="password" type="date"  class="form-control" name="commentcreate">
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input id="password" type="date"  class="form-control" name="commentmodifyfrom">
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          <label for="exampleInputPassword1">To:</label>
                                          <input id="password" type="date"  class="form-control" name="commentmodifyto">
                                      </div>
                                  </div>
                              </div>
                          </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('lead.export')}}" data-toggle="modal" data-target="#modal-default1" class="btn btn-sm btn-warning"><i class="fa fa-arrow-down"></i>  Import Comments</a>
